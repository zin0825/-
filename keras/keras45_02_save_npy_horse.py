# keras41_ImageDataGenerator4_horse
...
np.save(np_path + 'kares45_02_y_train.npy', arr=xy_train[0][1])   # 통데이터로 저장해야 함
np.save(np_path + 'kares45_02_x_test.npy', arr=xy_test[0][0])  
np.save(np_path + 'kares45_02_y_test.npy', arr=xy_test[0][1])  
