...
#     filepath='./_save/keras29_mcp/keras29_mcp3.hdf5'   # 좋은놈이 계속 갱신하면서 저장하기 때문에 1개만 있음
# )
...
model = load_model('./_save/keras29_mcp/keras29_3_save_model.hdf5')  
...
model2 = load_model('./_save/keras29_mcp/keras29_3_save_model.hdf5')  
