...
#  validation_split는 0.3은 좀 높으니까 0.2~0.1이 대체적으로 좋다 트레인이 많을수록 훈련이 잘 됨
# 발리데이션이랑 테스트는 검증이랑 평가하는 거라 버려지는 데이터하고 생각하면 됨. 어느정도는 작게 주는게 좋다
# 정답은 아니지만 통상적으로 8:2 정도가 좋음

path = './_save/keras62_04/'
model.save(path + 'keras62_04_08.h5')
...
# 로스 :  [0.2981449365615845, 0.06498353183269501, 0.23316138982772827]
# 예측값 :  [[3091.362 ]
#  [3092.363 ]
#  [3093.3645]
#  [3094.3657]
...
# 로스 :  [0.0018932819366455078, 0.00011744499352062121, 0.0017758369212970138]
# 예측값 :  [[3091.0808]
#  [3092.0808]
#  [3093.0803]
#  [3094.0808]
