...
x_pred2 = to_categorical(x_pred2, num_classes=31)
print(pad_x.shape)   # (1, 5, 31)
print(x_pred2.shape)   # (1, 5, 31)

x_pred3 = x_pred2.reshape(1, 5, 31)
print(x_pred3.shape)   # (1, 5, 31)
...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(filters=80, kernel_size=2, input_shape=(5, 31)))
...
print('로스 : ', loss[0])
print('태운이 참 재미있다 : ', np.round(y_pred))
