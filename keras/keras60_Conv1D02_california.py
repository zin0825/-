...
#2. 모델구성
model = Sequential()
model.add(Conv1D(filters=300, kernel_size=2, input_shape=(8,1)))   # input_shape=(3,1) 행무시
...
filepath = "".join([path, 'k59_02_01_',date, '_' , filename]) 
...
# Conv1D
# r2스코어 :  0.48918261220407666
# 걸린시간 :  9.92 초
# 로스 :  [0.7125592231750488, 0.0007267441833391786]
# k59_02

# r2스코어 :  0.01023434527048428
# 걸린시간 :  4.09 초
# 로스 :  [1.3806627988815308, 0.0007267441833391786]
# k59_02_01_