...
# 리스트 대괄호 안에 거 바꿀수 있다. 튜플 중괄호 안에 거 바꿀 수 없다.
...
print(xy_data[0][0].shape)   # (32, 28, 28, 1)  이터레이터의 첫번째 놈을 훈련

print(xy_data[3][0].shape)   # (4, 28, 28, 1)

# print(xy_data[4][0].shape)   
# # ValueError: Asked to retrieve element 4, but the Sequence has length 4
...
# # batch_size=augment_size  통배치를 안하면 (32, 28, 28, 1)로 나옴.  디폴트 32
...
# # .next()를 하면 첫번째 배치가 나옴, 안 할 경우 통배치가 나옴
# # 모르면 걍 .shpae 찍어보기
