...
# exit()
pad_x_perd = pad_sequences(x_pred2, maxlen=5)
print(pad_x_perd)   # [[0 0 4 1 3]]
print(x_pred2.shape)   # (1, 5)

x_pred_ohe = to_categorical(pad_x_perd, num_classes=31)
print(x_pred_ohe.shape)   # (1, 5, 31)
print(x_pred_ohe.shape)   # (1, 5, 31)

x_pred_ohe = x_pred_ohe.reshape(1, 5, 31)
print(x_pred_ohe.shape)   # (1, 5, 31)
