...
#2. 모델구성
model = Sequential()
model.add(LSTM(300, input_shape=(8,1)))   
...
filepath = "".join([path, 'k59_02_',date, '_' , filename]) 
...
# LSTM
# r2스코어 :  0.5313917699682158
# 걸린시간 :  12.74 초
# 로스 :  [0.6536797881126404, 0.0007267441833391786]
# k59_02_


# r2스코어 :  0.4221591821537747
# 걸린시간 :  12.1 초
# 로스 :  [0.8060527443885803, 0.0007267441833391786]
# k59_02_01_