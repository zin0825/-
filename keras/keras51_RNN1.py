...
# model.add(SimpleRNN(units=60, input_shape=(3,1)))   # units=60, 3 = timesteps, 1 = features
# model.add(LSTM(units=60, input_shape=(3,1)))   # 안에 있는 units는 다 똑같음
model.add(GRU(units=60, input_shape=(3,1)))   
