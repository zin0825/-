...
filepath = "".join([path, 'k59_12_01_',date, '_' , filename])    # 문자열을 만드는데 아무것도 없는 공문자를 만들고
...
"""sample_csv.to_csv(path + "sample_submission_0813_1558.csv")"""
...
# acc score :  0.8995
# 걸린 시간 :  788.15 초
# 로스 :  [0.32303014397621155, 0.8995000123977661]
# k59_12_

# acc score :  0.8995
# 걸린 시간 :  362.32 초
# 로스 :  [0.3262142837047577, 0.8995000123977661]
# k59_12_01_
