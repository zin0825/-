...
# np.save(np_path + 'kares43_01_x_train.npy', arr=xy_train[0][0])   # save용 xy_train을 여기에 저장
...
x_train = np.load(np_path + 'kares43_01_x_train.npy')   # load용
...
# start = time.time()
# hist = model.fit(xy_train[0][0], xy_train[0][1], epochs=160, batch_size=36,
#           verbose=1, 
