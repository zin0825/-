...
from sklearn.ensemble import RandomForestRegressor  # 회귀방식
...
#2. 모델
model = RandomForestClassifier(random_state=333)   # 트리계열 찾아보기
...
evr = pca.explained_variance_ratio_   # 설명 가능한 변화율 / 레이티오
print(evr)
# model.score :  0.9333333333333333
# [0.73616646 0.22089149 0.03787614]
...
# pca = PCA(n_components=4)   # 4로 해도 되지만 굳이 4를 할 필요는 없음
# [0.73616646 0.22089149 0.03787614 0.00506591]
# 0.9999999999999999
...
# [0.73616646 0.95705795 0.99493409 1.        ]
